...
export namespace CanonicalInputBinding {
    export function fromKeyboardEvent(e: KeyboardEvent): CanonicalInputBinding {
        return toCanonicalKeyboardRepresentation(<Key>e.which, Kind.Down, e.shiftKey, e.ctrlKey, e.altKey, e.metaKey, e.repeat);
    }
    export function fromMouseEvent(e: MouseEvent, kind: Kind): CanonicalInputBinding {
        return toCanonicalMouseRepresentation(<MouseButton>e.button, kind, e.shiftKey, e.ctrlKey, e.altKey, e.metaKey);
    }

    export function fromMouseMoveEvent(e: MouseEvent): CanonicalInputBinding {
