import { Http } from '../angular.index';
import 'rxjs/add/operator/toPromise';
import { AsynchronousCollectionEditorSolver } from './AsynchronousCollectionEditorSolver';
import { BaseViewModel, IChangePropagator } from '../base.component';
import { CommandInstruction } from './../commands/commandInstruction';
import { AppBase, AppBaseComponent } from '../app.base/app.base.component';
...
export class ChangesPropagator implements IChangePropagator {
    ...
    constructor(
        ...
        private readonly createNewAppViewModel: () => AppBase) {
    }
    ...
    private processPropertyChange(component: BaseViewModel, change: IPropertyChange) {
        if (change.id === AppBaseComponent.id && change.propertyName == 'commandManager') {
